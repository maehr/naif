...
![Poster summarizing findings on the use of quantitative scientometric indicators in Swiss higher education institutions.](images/poster.png){fig-cap="Poster summarizing findings on the use of quantitative scientometric indicators in Swiss higher education institutions. Rights: Authors, used with permission."}

## What we found

The poster addressed four questions. First, QSI adoption is growing — 24 Swiss institutions have signed DORA and 16 are CoARA signatories — but stakeholders struggle to translate these declarations into appropriate practices. Second, indicators are primarily used at the organisational level for monitoring research profiles, collaboration networks, open access shares, and citation patterns, rather than for evaluating individual researchers (based on an ETH Zurich case study). Third, data quality emerged as a non-negotiable prerequisite: metrics are often flawed or misapplied, and meaningful analysis requires multiple sources with rigorous cleaning. Fourth, the future of responsible QSI lies in deeper expert collaboration, dialogue-based approaches, context-first design, and a broader scope that includes open research data, open science, and media visibility.
