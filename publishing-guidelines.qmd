...
This public guide explains how to publish NAIF blog posts and event entries. It is intended for project partners and anyone contributing content.
...
- Post assets: `blog/posts/<entry>/images/*`
- Event assets: `events/<entry>/images/*`
- Rendered output lives in `_site/` (do not edit `_site/` manually).

## Blog post guidance

Use a blog post for updates, progress reporting, findings, or opinion pieces.
...
- `categories`: exactly one: `Blog Post`
- `tags`: exactly 3 tags
...
- NAIF deliverables are archived on Zenodo: https://zenodo.org/communities/naif
...
```markdown
{{< include blog/_template-post/index.qmd >}}
```

### Event template

```markdown
{{< include blog/_template-event/index.qmd >}}
```
