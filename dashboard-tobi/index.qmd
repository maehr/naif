...
This dashboard reuses TOBI project data on Swiss higher education institutions and presents it in a compact NAIF format.

- Data basis and methodology: Dederke, J., Koch, M., & Willemin, S. (2024). *The Representation of Swiss Higher Education Institutions in Five Bibliometric Databases*. <https://doi.org/10.3929/ethz-b-000726102>
- Project context: TOBI (Towards Open Bibliometric Indicators), ETH Library. <https://eth-library.github.io/tobi/>
- Data providers represented in this dashboard: Dimensions, Scopus, Web of Science, OpenAIRE, and OpenAlex.
- Dashboard adaptation and maintenance: Dr Moritz Mähr (NAIF project).
